...
final class ARCSecureStorage {
  ARCSecureStorage._();

  static const _location = 'ARCSecureStorage';
  static final _instance = ARCSecureStorage._();
  static ARCSecureStorage get instance => _instance;
  ...
  Future<void> write({required String key, required String? value}) {
    ARCLogger.debug(location: _location, message: 'Writing value: $value with key: $key');
  ...
  Future<T?> read<T extends Object>({required String key, required T Function(String rawString) converter}) async {
    try {
      ...
      ARCLogger.debug(location: _location, message: 'Read value with key - $key. Got: $response');
      if (response == null) {
        return null;
      }
  ...
  Future<void> delete({required String key}) {
    ARCLogger.debug(location: _location, message: 'Deleting value with key - $key');
